...
<div class="page-body">
                        ...
                        <div class="col-md-4">
                         ...
                         <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('meta_description') is-invalid @enderror" name="meta_description" value="{{ old('meta_description') }}" placeholder="meta description">
                     ...
                     <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('is_published') is-invalid @enderror" name="is_published" id="is_published">
                                ...
                                <option value="0" {{ old('is_published') == '0' ? 'selected' : '' }}>Not Publish</option>
                            </select>
                                @error('is_published')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label" >Excerpt Blog<small class="text-danger">*</small></label>
                                    <textarea name="excerpt" id="" cols="3" rows="3" class="form-control"></textarea>
                                    @error('excerpt')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label" >Content Blog<small class="text-danger">*</small></label>
                                    <textarea name="content"  id="editor" cols="6" rows="6" class="form-control"></textarea>
                                    @error('content')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                            </div>
    ...
    <div class="col-md-4">
        <div class="mb-3">
            ...
            {{-- Preview Image --}}
            <img id="imgPreview" 
                 src="{{ isset($blog) && $blog->image ? asset('storage/blogs/' . $blog->image) : asset('storage/blogs/default.png') }}" 
