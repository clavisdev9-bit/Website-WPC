...
@section('content')
 ...
 <div class="page-header d-print-none">
    ...
    <div class="row g-2 align-items-center">
        ...
        <div class="btn-list">
            <a href="{{ route('Administrator.create.agent.network.country') }}" class="btn btn-outline-azure">
...
<meta name="route-agent-network-country-get" content="{{ route('Administrator.get.agent.network.country') }}">
