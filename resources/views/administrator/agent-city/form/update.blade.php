  ...
  <div class="page-body">
    <div class="container-xl">
      <div class="card">
        ...
        <div class="card-body">
          <form  action="{{ route('Administrator.agent.network.city.view.updates') }}"
           method="POST"
           ...
           <div class="mb-1">
            ...
            <select name="country" id="country" class="form-control">
                ...
                @foreach ($country as $ct)
                    <option 
                        value="{{ $ct->id }}" 
                        {{ (string) old('country', $row->country_id ?? '') === (string) $ct->id ? 'selected' : '' }}>
                        {{ $ct->name }}
                    </option>
                @endforeach
            </select>
