  ...
  <!-- Header Start -->
        <div class="container-fluid bg-breadcrumb-tracking">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Services Transportation</h4>
                <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item text-light fw-bolder"><a href="">Home</a></li>
                    <li class="breadcrumb-item active text-primary">Transportation Logistic</li>
                </ol>    
                ...
                <div class="tab-pane fade show active" id="import" role="tabpanel" aria-labelledby="logistic-tab">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card border-0 shadow-lg p-3" style="background-color: #0744a0; color: #fff;">
                                ...
                                <div class="list-group list-group-flush">
                                    <a href="{{ route('users.tracking.system') }}" class="list-group-item list-group-item-action active bg-white text-dark fw-bold border-0 border-start border-4 border-warning">Tracking System</a>
                                    <a href="{{ route('users.consolidation.service') }}" class="list-group-item list-group-item-action border-0">Consolidation Service</a>
                                    <a href="#" class="list-group-item list-group-item-action border-0">Inter Model</a>
                                    <a href="#" class="list-group-item list-group-item-action border-0">Rail Service</a>
                                    <a href="#" class="list-group-item list-group-item-action border-0">Freight Forwarder</a>
                                </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <p class="text-secondary">Transportation Brokerage Services</p>
                            <p class="text-dark fw-bold">In the logistics world, transportation is the most important instrument, which is in contrast with warehousing operational. Geographically, we can study all the delivery destination, nevertheless we invariably fail to recall that some location has limited access. Not all kind of vehicle could enter some of the destination. Therefore, in WPC Logistics, we established a stop-to-go transhipment method, in order to make sure we implement the product delivery on time, without more expenses paid by the customers. </p>
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-2"><i class="fas fa-solid fa-caret-right text-primary me-2"></i> <a href=" ">Inter Model</a></li>
                                <li class="mb-2"><i class="fas fa-solid fa-caret-right text-primary me-2"></i> <a href=" ">Rail Service</a></li>
                                <li class="mb-2"><i class="fas fa-solid fa-caret-right text-primary me-2"></i> <a href=" ">Freight Forwarder</a></li>
