                ...
                <div class="tab-pane fade show active" id="import" role="tabpanel" aria-labelledby="logistic-tab">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card border-0 shadow-lg p-3" style="background-color: #0744a0; color: #fff;">
                                ...
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="{{ route('users.rail.service') }}" class="list-group-item list-group-item-action active bg-white text-dark fw-bold border-0 border-start border-4 border-warning">Rail Service</a>
                        ...
                        <div class="col-md-8">
                            ...
                            <p class="text-dark fw-bold">Train distribution is a transportation model which give benefit in time as well as cost. Consequently, WPC Logistics provides end-to-end rail service which then proceed with our other land inter model transportation.</p>
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-2"><i class="fas fa-solid fa-caret-right text-primary me-2"></i> <a href="{{ route('users.freight.forwarder') }}">Inter Model</a></li>
