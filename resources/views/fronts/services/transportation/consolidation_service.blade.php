                ...
                <div class="tab-pane fade show active" id="import" role="tabpanel" aria-labelledby="logistic-tab">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card border-0 shadow-lg p-3" style="background-color: #0744a0; color: #fff;">
                                ...
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="{{ route('users.consolidation.service') }}" class="list-group-item list-group-item-action active bg-white text-dark fw-bold border-0 border-start border-4 border-warning">Consolidation Service</a>
                                    ...
                                    <a href="{{ route('users.freight.forwarder') }}" class="list-group-item list-group-item-action border-0">Freight Forwarder</a>
                                </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <p class="text-dark fw-bold">This particular service is by far the strongest value WPC Logistic can offer and in the same time, differ us from other logistic company. The service works by consolidate one shipment with other shipment, in order to minimise transportation cost, as well as give benefit to all party. We manage every single one of the routes as the entire strategic plan to implement each delivery as perfect as possible. Such integrated system will incorporate not only the transportation but also warehouse and logistic handling, from the product undertaking, loading, warehousing, to distributing.</p>
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-2"><i class="fas fa-solid fa-caret-right text-primary me-2"></i> <a href="{{ route('users.freight.forwarder') }}">Freight Forwarder</a></li>
