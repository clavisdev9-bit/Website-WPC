                ...
                <div class="tab-pane fade show active" id="import" role="tabpanel" aria-labelledby="logistic-tab">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card border-0 shadow-lg p-3" style="background-color: #0744a0; color: #fff;">
                                ...
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="{{ route('users.inter.model') }}" class="list-group-item list-group-item-action  active bg-white text-dark fw-bold border-0 border-start border-4 border-warning">Inter Model</a>
                                    <a href="{{ route('users.rail.service') }}" class="list-group-item list-group-item-action">Rail Service</a>
                                    <a href="{{ route('users.freight.forwarder') }}" class="list-group-item list-group-item-action">Freight Forwarder</a>
                                </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <p class="text-dark fw-bold">At present time, transportation method could be done in various ways, from trucks, trains, ship, plane, as well as motorcycle. WPC Logistics see that as another strategic plan to conduct more reliable logistic service to the customer. Therefore, since the beginning, WPC Logistic has assemble various coordination, as well as transportation mapping strategy, to assure that every delivery conducted perfectly.</p>
