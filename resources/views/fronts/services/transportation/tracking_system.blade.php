                ...
                <div class="tab-pane fade show active" id="import" role="tabpanel" aria-labelledby="logistic-tab">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <p class="text-dark fw-bold">Nowadays, in the modern universe, tracking technology is no longer an innovation, but more of monitoring system which grow into significant factor to develop a logistic business. </p>
