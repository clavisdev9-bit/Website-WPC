                ...
                <div class="tab-pane fade show active" id="import" role="tabpanel" aria-labelledby="logistic-tab">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card border-0  p-3" style="background-color: #0744a0; color: #fff;">
                                ...
                                <div class="list-group list-group-flush">
                                    <a href="{{ route('users.dedicated.warehouse') }}" class="list-group-item list-group-item-action">Dedicated Warehouse</a>
                                    <a href="{{ route('users.public.warehouse') }}" class="list-group-item list-group-item-action ">Public Warehouse</a>
                                    <a href="{{ route('users.warehouse.management.system') }}" class="list-group-item list-group-item-action active bg-white text-dark fw-bold border-0 border-start border-4 border-warning">Warehouse Management System</a>
                                </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <p class="text-dark fw-bold">WPC Logistics recognise that having a system which could monitor and analyse process of product handling and in the same time could give information to the customers are the most important thing in warehousing project.</p>
                            <p class="text-dark fw-bold">For this reason, WPC Logistics invest time, money and energy to built the system that not only could make the process more effortless for the handler as well as to the customers.</p>
                            <p class="text-dark fw-bold">WPC Logistics introduce "Custom to Fit", on going warehouse management system that involved customers of handling process since day one, where customers give every detail to the data base to simplify warehouse operation and facilitate report process.</p>
