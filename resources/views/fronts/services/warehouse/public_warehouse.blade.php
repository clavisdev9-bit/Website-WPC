                ...
                <div class="tab-pane fade show active" id="import" role="tabpanel" aria-labelledby="logistic-tab">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card border-0  p-3" style="background-color: #0744a0; color: #fff;">
                                ...
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="{{ route('users.public.warehouse') }}" class="list-group-item list-group-item-action active bg-white text-dark fw-bold border-0 border-start border-4 border-warning">Public Warehouse</a>
                        ...
                        <div class="col-md-8">
                            ...
                            <p class="text-dark fw-bold">As the name implies, public warehouse is storeroom that can be use by public. In addition, WPC Logistics understand that not every product could be placed side by side, therefore WPC Logistics create particular criteria so that every customers could use the public warehouse while guarantee the safety of every product stored.</p>
                            <p class="text-dark fw-bold">Public warehouse is more suitable for short term use with less complicated handling process.</p>
