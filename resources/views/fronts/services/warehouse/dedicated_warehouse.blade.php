                ...
                <div class="tab-pane fade show active" id="import" role="tabpanel" aria-labelledby="logistic-tab">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <p class="text-dark fw-bold">WPC Logistics recognise different needs of warehouse for every customers, which depends on type and total of products. Therefore, WPC Logistics create Dedicated Warehouse to suffice every customers need.</p>
                            <p class="text-dark fw-bold">WPC Logistics provides assistance to analyse the needs of every customers before then  give recommendation in order to create warehouse as require, but also minimum in term of cost.</p>
                             <p class="text-dark fw-bold">Dedicated warehouse is suitable for long term use or for products that need complicated handling process.</p>
