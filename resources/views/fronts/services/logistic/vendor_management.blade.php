                ...
                <div class="tab-pane fade show active" id="import" role="tabpanel" aria-labelledby="logistic-tab">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card border-0  p-3" style="background-color: #0744a0; color: #fff;">
                                ...
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="{{ route('users.vendor.management') }}" class="list-group-item list-group-item-action bg-white text-dark fw-bold border-0 border-start border-4 border-warning">Vendor Management</a>
                        ...
                        <div class="col-md-8">
                            ...
                            <p class="text-dark fw-bold">On going process to define the procurement capability to support costumer business plan, by using the method of in-house and outsource to create the balance of product quality, service level, on-time delivery and technical support.</p>
                          
                                <ul>
                                    <ol><li class="text-dark fw-bold">Loading time window</li>
                                        <p class="text-dark fw-bold">Every site of warehouse have a different distance and the loading time window of each vendor will set accordingly.</p>
                                    </ol>
                                </ul>


                                 <ul>
                                    <ol><li class="text-dark fw-bold">Process time window</li>
                                        <p class="text-dark fw-bold">Each process of the handling product from the time of the purchase order to picking process until ready to be delivered will be put in process time window by WPC Logistics system that notify all the party involve in the delivery process.</p>
                                    </ol>
                                </ul>

                                <ul>
                                    <ol><li class="text-dark fw-bold">Delivery time window</li>
                                        <p class="text-dark fw-bold">Each delivery will be based on time window of each customer in order to make the product be in line will customer schedule basis for their production or market distribution area by daily, weekly or monthly. WPC Logistics integrated system will generate the report to each department, tracking system can be implemented and auto mail program will notify each department once the shipment received by each division or market distribution.</p>
                                    </ol>
                                </ul>
