                ...
                <div class="tab-pane fade show active" id="import" role="tabpanel" aria-labelledby="logistic-tab">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card border-0  p-3" style="background-color: #0744a0; color: #fff;">
                                ...
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="{{ route('users.inventory') }}" class="list-group-item list-group-item-action bg-white text-dark fw-bold border-0 border-start border-4 border-warning">Inventory</a>
                        ...
                        <div class="col-md-8">
                            ...
                            <p class="text-dark fw-bold">Inventory is the most important, the accuracy targeted at 99,99% with less margin error. WPC Logistics believes in operational system review, which would make inventory level to achieve maximum target.</p>
