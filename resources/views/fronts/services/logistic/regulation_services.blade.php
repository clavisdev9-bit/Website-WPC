                ...
                <div class="tab-pane fade show active" id="import" role="tabpanel" aria-labelledby="logistic-tab">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card border-0  p-3" style="background-color: #0744a0; color: #fff;">
                                ...
                                <div class="list-group list-group-flush">
                                    <a href="{{ route('users.regulation.services') }}" class="list-group-item list-group-item-action active bg-white text-dark fw-bold border-0 border-start border-4 border-warning">Regulation Services</a>
                        ...
                        <div class="col-md-8">
                            ...
                            <p class="text-dark fw-bold">Every product distribution, export or import, always has regulation to comply, therefore WPC Logistics guarantee to conduct observation and give away information regarding regulation which customers have to comply. In other words, regulation become the very foundation for WPC Logistics in distribution service. </p>
