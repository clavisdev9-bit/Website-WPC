                ...
                <div class="tab-pane fade show active" id="import" role="tabpanel" aria-labelledby="logistic-tab">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card border-0  p-3" style="background-color: #0744a0; color: #fff;">
                                ...
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="{{ route('users.warehouse.and.design') }}" class="list-group-item list-group-item-actionactive bg-white text-dark fw-bold border-0 border-start border-4 border-warning">Warehouse and Design</a>
                        ...
                        <div class="col-md-8">
                            ...
                            <p class="text-dark fw-bold">WPC Logistics carefully choose warehouse location so that it would be suitable for costumers comfort and need, including the measurement of the warehouse. Each location became important point of target market distribution. Geographically, warehouse location could be selected by several significant factors, such as accessibility, human resources, as well as transportation in order to convey an integrated services. In other hand, product service also become another significant factor to decide the location of the warehouse. Therefore, strategic warehouse location could be a very expensive expenditure for the company, which could be minimise by using warehouse service provided by WPC Logistics.</p>
