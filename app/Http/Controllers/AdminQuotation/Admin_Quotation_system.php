  ...
  public function Get_Quotations(Request $request)
{
    ...
    if ($request->ajax()) {
         $data = Cache::remember('quotations_data', 60, function () {
            $response = Http::withoutVerifying()->get('https://1821986ae1e4.ngrok-free.app/quotes');
        ...
        $commodities = Cache::remember('commodities_lookup', 60, function () {
            $res = Http::withoutVerifying()->get('https://1821986ae1e4.ngrok-free.app/lookups/commodities');
